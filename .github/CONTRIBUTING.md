# Contributing to WSClientCircuitBreaker
...
1. To avoid duplicated effort, it might be good to check the [issue tracker](https://github.com/Jyllands-Posten/WSClientCircuitBreaker/issues) and [existing pull requests](https://github.com/Jyllands-Posten/WSClientCircuitBreaker/pulls) for existing work.
   - If there is no ticket yet, feel free to [create one](https://github.com/Jyllands-Posten/WSClientCircuitBreaker/issues/new) to discuss the problem and the approach you want to take to solve it.
1. [Fork the project](https://github.com/Jyllands-Posten/WSClientCircuitBreaker#fork-destination-box) on GitHub. You'll need to create a feature-branch for your work on your fork, as this way you'll be able to submit a pull request against the mainline WSClientCircuitBreaker.
...
1. Once your feature is complete, prepare the commit with a good commit message, for example: `Adding awesome new feature #42` (note the reference to the ticket it aimed to resolve).
1. If it's a new feature, or a change of behaviour, document it in the [README](https://github.com/Jyllands-Posten/WSClientCircuitBreaker/tree/master/README.md), remember, an undocumented feature is not a feature.
